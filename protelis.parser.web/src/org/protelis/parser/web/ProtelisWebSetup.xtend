...
import org.protelis.parser.ide.ProtelisIdeModule
...
class ProtelisWebSetup extends ProtelisStandaloneSetup {
	...
	override Injector createInjector() {
		return Guice.createInjector(Modules2.mixin(new ProtelisRuntimeModule, new ProtelisIdeModule, new ProtelisWebModule))
	}
